...
export const getDashboradStats = async (req, res, next) => {
    try {
        ...
        if (myCahe.has("admin-stats")) {
            ...
            const [thisMonthProducts, thisMonthOrders, thisMonthUsers, lastMonthProducts, lastMonthOrders, lastMonthUsers, productsWithCategory, userCount, allOrders, lastSixMonthOrders, categories, lastFiveOrders, maleUser,] = await Promise.all([
